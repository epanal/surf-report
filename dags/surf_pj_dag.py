...
# Surfline location identifier for Princeton Jetty, Half Moon Bay
#  princeton_jetty = '5842041f4e65fad6a7708970'
...
def download_data():
    ...
    hmb_surf_report = report.df.drop(columns=['utcOffset','swells'])

    #convert to csv
    surf_report.to_csv(dag_path+'/raw_data/'+ reportdate +'-hmb-surf-report.csv',header=False)
